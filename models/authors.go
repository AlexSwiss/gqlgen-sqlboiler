...
type Author struct {
	...
	BookID    null.Int    `boil:"book_id" json:"book_id,omitempty" toml:"book_id" yaml:"book_id,omitempty"`
...
var AuthorWhere = struct {
	...
	BookID    whereHelpernull_Int
}{
	ID:        whereHelperint{field: "`authors`.`id`"},
	Firstname: whereHelpernull_String{field: "`authors`.`firstname`"},
	Lastname:  whereHelpernull_String{field: "`authors`.`lastname`"},
	BookID:    whereHelpernull_Int{field: "`authors`.`book_id`"},
}
...
var (
	authorAllColumns            = []string{"id", "firstname", "lastname", "book_id"}
	authorColumnsWithoutDefault = []string{"firstname", "lastname", "book_id"}
