...
var BookWhere = struct {
	...
	Name:     whereHelpernull_String{field: "`books`.`name`"},
	Category: whereHelpernull_String{field: "`books`.`category`"},
}
...
var (
	bookAllColumns            = []string{"id", "name", "category"}
	bookColumnsWithoutDefault = []string{"name", "category"}
